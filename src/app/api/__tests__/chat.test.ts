...
import { GET as getMessages, POST as sendMessage } from '../chat/messages/route';
...
describe('Chat Messages API', () => {
  ...
  describe('GET /api/chat/messages', () => {
    it('returns 401 when not authenticated', async () => {
      ...
      const req = new NextRequest('http://localhost:3000/api/chat/messages?chatRoomId=room_1');
    ...
    it('returns messages for valid participant', async () => {
      ...
      mockDb.execute
        ...
        .mockResolvedValueOnce({
          rows: [
            {
              id: 'msg_2', chatRoomId: 'room_1', senderId: 'user-2',
              sender_name: 'João', sender_role: 'CAREGIVER',
              content: 'Bom dia!', messageType: 'text',
              metadata: null, isEdited: 0, createdAt: '2025-02-28T10:00:00',
            },
            {
              id: 'msg_1', chatRoomId: 'room_1', senderId: 'user-1',
              sender_name: 'Maria', sender_role: 'FAMILY',
              content: 'Olá!', messageType: 'text',
              metadata: null, isEdited: 0, createdAt: '2025-02-28T09:00:00',
            },
          ],
        });
