...
const { mockConstructEvent, mockHandleWebhook, mockVerifySignature } = vi.hoisted(() => ({
...
describe('POST /api/webhooks/stripe', () => {
  ...
  function createStripeRequest(body = '{"type":"checkout.session.completed"}'): NextRequest {
...
describe('POST /api/webhooks/easypay', () => {
  ...
  function createEasypayRequest(body: Record<string, unknown> = baseWebhookBody): NextRequest {
