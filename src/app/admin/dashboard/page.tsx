          ...
          <div className="grid gap-3 md:grid-cols-4">
            ...
            >
              ...
              <Badge className="bg-destructive">
                {stats?.alerts.pendingDisputes || 0}
              </Badge>
            </Link>
            <Link
