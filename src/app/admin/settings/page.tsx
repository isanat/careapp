              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Porcentagem sobre o valor do contrato (cuidador recebe
                      90%)
                    </p>
                  </div>
                </>
            ...
            <CardContent className="flex items-start gap-4 p-4">
              ...
              <div>
                ...
                <p className="text-sm text-warning/90">
                  Alterações nas taxas afetam apenas novos contratos. Contratos
                  existentes mantêm as taxas originais.
                </p>
              </div>
            </CardContent>
          </Card>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setSettings({ ...settings, kycProvider: v })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          easypayAccountId: e.target.value,
                        })
                      }
                      placeholder="12345"
                    />
                  ...
                  <Button
                    ...
                    disabled={
                      !settings.easypayAccountId || !settings.easypayApiKey
                    }
                  >
                    Testar Conexão
                  </Button>
        ...
        <TabsContent value="video" className="space-y-6 mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure a integração para reuniões por vídeo entre famílias e
                cuidadores
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setSettings({ ...settings, videoProvider: v })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
              ...
              {integrations.map((integration) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <Badge
                      variant={
                        integration.connected ? "default" : "destructive"
                      }
                    >
