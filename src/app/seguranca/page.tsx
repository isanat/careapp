...
export const metadata: Metadata = {
  ...
  description:
    "Saiba como o Evyra protege seus dados e garante transações seguras.",
};
    ...
    <div className="container px-4 py-12 mx-auto max-w-3xl">
      ...
      <div className="grid gap-6 md:grid-cols-2 mb-8">
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Todos os dados são criptografados com TLS 1.3. Senhas são
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Todos os pagamentos são processados por parceiros certificados com
              total proteção.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Sistema de verificação KYC para cuidadores que desejam mais
              credibilidade.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Contratos digitais com registo seguro para proteção jurídica de
              ambas as partes.
            </p>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            ...
            (LGPD) do Brasil e o Regulamento Geral sobre a Proteção de Dados
