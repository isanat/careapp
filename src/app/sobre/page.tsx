        ...
        <div className="container px-4 mx-auto">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <div className="space-y-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              <p>
                Há momentos em que a vida coloca uma família diante de uma
                decisão que não pode ser errada. A {APP_NAME} existe para esses
                momentos — para ser a presença segura entre a necessidade e a
                tranquilidade de saber que alguém de confiança está presente.
              </p>
              <p>
                Não somos um marketplace. Somos a infraestrutura que organiza o
                processo inteiro: verificação de profissionais, contratos,
                pagamentos e comunicação — num único lugar, com rigor europeu.
              </p>
            </div>
          </div>
        </div>
            ...
            <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
              <CardContent className="p-8">
                <h3 className="text-xl font-semibold mb-2">
                  {t.sobrePage.stats.title}
                </h3>
                <p className="text-xs text-muted-foreground mb-6">
                  Plataforma em fase de lançamento - Números actualizados em
                  tempo real
                </p>
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {t.sobrePage.stats.caregivers}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-3xl font-bold text-primary">100+</p>
                    <p className="text-sm text-muted-foreground">
                      {t.sobrePage.stats.families}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-3xl font-bold text-primary">500+</p>
                    <p className="text-sm text-muted-foreground">
                      {t.sobrePage.stats.hours}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-3xl font-bold text-primary">1</p>
                    <p className="text-sm text-muted-foreground">
                      {t.sobrePage.stats.countries}
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  {t.sobrePage.values.humanity.title}
                </h3>
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  {t.sobrePage.values.transparency.title}
                </h3>
                <p className="text-muted-foreground">
            ...
            <Card className="border-0 shadow-lg">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  {t.sobrePage.values.appreciation.title}
                </h3>
                <p className="text-muted-foreground">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">
                  {t.sobrePage.contact.email}
                </h3>
                <p className="text-muted-foreground text-sm">
                  {t.sobrePage.contact.emailValue}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">
                  {t.sobrePage.contact.phone}
                </h3>
                <p className="text-muted-foreground text-sm">
                  {t.sobrePage.contact.phoneValue}
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold mb-2">
                  {t.sobrePage.contact.location}
                </h3>
                <p className="text-muted-foreground text-sm">
                  {t.sobrePage.contact.locationValue}
                </p>
              </CardContent>
            </Card>
          </div>
