    ...
    <AppShell>
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <BloomBadge
            variant={session?.user?.status === "ACTIVE" ? "success" : "warning"}
          >
              ...
              <div className="space-y-2">
                {pendingSteps.map((step) => (
                  <Link
                    key={step.key}
                    href={step.href}
                    className="flex items-center gap-3 py-2.5 px-3 hover:bg-secondary/50 rounded-lg transition-colors group"
                  >
        ...
        <div className="space-y-4">
          <BloomSectionDivider title="Benefícios" borderColor="primary" />
                ...
                : [
                    {
                      ...
                      sub: "Receba pontualmente",
                    },
                    {
                      title: "Perfil Verificado",
                      sub: "Mais famílias confiam",
                    },
                    {
                      title: "Reputação Pública",
                      sub: "Avaliações verificáveis",
                    },
