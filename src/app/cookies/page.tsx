...
export const metadata: Metadata = {
  ...
  description:
    "Política de cookies do Evyra - como utilizamos cookies para melhorar a sua experiência.",
};
  ...
  return (
    <div className="container px-4 py-12 mx-auto max-w-3xl">
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <p className="text-muted-foreground">
            ...
            dispositivo que nos ajudam a melhorar a sua experiência no Evyra.
            Permitem que recordemos as suas preferências e compreendamos como
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Necessários para o funcionamento básico da plataforma. Não podem
              ser desativados.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Ajudam-nos a compreender como utiliza a plataforma para podermos
              melhorá-la.
            </p>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Pode gerir as suas preferências de cookies nas definições do seu
            navegador. Note que desativar certos cookies pode afetar a
