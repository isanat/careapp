    ...
    <main className="container-page space-y-10 py-10">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {colors.map((color) => (
            <div key={color.name} className="rounded-[14px] border border-border/10 bg-surface p-4">
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-[14px] border border-border/10 bg-surface p-6">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {spacing.map((item) => (
            <div key={item.name} className="rounded-[14px] border border-border/10 bg-surface p-4">
