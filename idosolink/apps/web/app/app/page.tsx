  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <Card className="bg-gradient-to-br from-white to-accent/35">
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <p className="text-text2">
              {role === 'CUIDADOR'
                ? 'Visual premium para avaliar propostas rapidamente, com foco em segurança e clareza.'
                : 'Encontre profissionais verificados e organize o cuidado com tranquilidade.'}
            </p>
            <Button asChild>
        ...
        <Card className="bg-gradient-to-br from-white to-secondary/15">
          <CardHeader>
            <CardTitle>Meus contratos</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-text2">Acompanhe contratos, pagamentos e status com linguagem humana e objetiva.</p>
